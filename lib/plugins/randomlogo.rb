...
class Logos
  REMOTE_LOGOS_LIST_FILE = 'https://raw.githubusercontent.com/gilbarbara/logos/app/app/logos.json'.freeze
...
class RandomLogo < Plugin
  ...
  def do_stuff(_match_results)
    ...
    system("wget https://raw.githubusercontent.com/gilbarbara/logos/master/logos/#{@correct_answer_file}")
